...
<div class="form">
	...
	<?php $form=$this->beginWidget('CActiveForm', array(
		'id'=>'goods-form',
		'method' => 'get',
		'action'=> Yii::app()->createUrl('/goods/search'),
	...
	<div class="row">
		...
		<?php echo $form->textField($model,'title', array('class'=> 'long-input')); ?>
	...
	<div class="row">
		...
		<?php echo $form->dropDownList($model, 'notshow', array(''=>"Не важно", '0'=>"Не скрыт", '1'=>"Скрыт")); ?>
